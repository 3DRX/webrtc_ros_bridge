...
// TODO(wjwwood): make this as a contribution to vision_opencv's cv_bridge
// package.
//   Specifically the CvImage class, which is this is most similar to.
/// A potentially owning, potentially non-owning, container of a cv::Mat and ROS
/// header.
/**
...
class ROSCvMatContainer {
  static constexpr bool is_bigendian_system =
      detail::endian::native == detail::endian::big;

 public:
  using SensorMsgsImageStorageType =
  ...
  explicit ROSCvMatContainer(const ROSCvMatContainer& other)
    ...
    if (std::holds_alternative<std::shared_ptr<sensor_msgs::msg::Image>>(
            other.storage_)) {
      storage_ =
          std::get<std::shared_ptr<sensor_msgs::msg::Image>>(other.storage_);
    } else if (std::holds_alternative<std::unique_ptr<sensor_msgs::msg::Image>>(
                   other.storage_)) {
      ...
      if (std::holds_alternative<std::shared_ptr<sensor_msgs::msg::Image>>(
        ...
        storage_ =
            std::get<std::shared_ptr<sensor_msgs::msg::Image>>(other.storage_);
                     ...
                     other.storage_)) {
        storage_ = std::make_unique<sensor_msgs::msg::Image>(
            *std::get<std::unique_ptr<sensor_msgs::msg::Image>>(
                other.storage_));
  ...
  /// Store an owning pointer to a sensor_msg::msg::Image, and create a cv::Mat
  /// that references it.
  IMAGE_TOOLS_PUBLIC
  explicit ROSCvMatContainer(
  ...
  /// Shallow copy the given cv::Mat into this class, but do not own the data
  /// directly.
  IMAGE_TOOLS_PUBLIC
  ROSCvMatContainer(const cv::Mat& mat_frame,
                    const std_msgs::msg::Header& header,
                    bool is_bigendian = is_bigendian_system);

  /// Move the given cv::Mat into this class.
  IMAGE_TOOLS_PUBLIC
  ROSCvMatContainer(cv::Mat&& mat_frame,
                    const std_msgs::msg::Header& header,
                    bool is_bigendian = is_bigendian_system);

  /// Copy the sensor_msgs::msg::Image into this contain and create a cv::Mat
  /// that references it.
  IMAGE_TOOLS_PUBLIC
  ...
  /// Get shared const pointer to the sensor_msgs::msg::Image if available,
  /// otherwise nullptr.
  IMAGE_TOOLS_PUBLIC
  ...
  /// Get a copy of the image as a sensor_msgs::msg::Image.
  IMAGE_TOOLS_PUBLIC
  void get_sensor_msgs_msg_image_copy(
...
template <>
struct rclcpp::TypeAdapter<webrtc_ros::ROSCvMatContainer,
                           sensor_msgs::msg::Image> {
  using is_specialized = std::true_type;
  using custom_type = webrtc_ros::ROSCvMatContainer;
  ...
  static void convert_to_ros_message(const custom_type& source,
    ...
    destination.step =
        static_cast<sensor_msgs::msg::Image::_step_type>(source.cv_mat().step);
  ...
  static void convert_to_custom(const ros_message_type& source,
    ...
    destination = webrtc_ros::ROSCvMatContainer(source);
  }
};
