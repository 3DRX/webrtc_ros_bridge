...
class WebrtcWebServerImpl : public WebrtcWebServer {
 public:
  WebrtcWebServerImpl(rclcpp::Node::SharedPtr nh,
                      int port,
  ...
  bool handle_list_streams(const async_web_server_cpp::HttpRequest& request,
    ...
    async_web_server_cpp::HttpReply::builder(
        ...
        .header("Cache-Control",
                "no-cache, no-store, must-revalidate, pre-check=0, "
...
WebrtcWebServer* WebrtcWebServer::create(rclcpp::Node::SharedPtr nh,
                                         int port,
                                         SignalingChannelCallback callback,
                                         void* data) {
