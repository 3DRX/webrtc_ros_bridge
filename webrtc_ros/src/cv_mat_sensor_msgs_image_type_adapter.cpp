...
ROSCvMatContainer::ROSCvMatContainer(
    ...
    : header_(NotNull(unique_sensor_msgs_image.get(),
                      "unique_sensor_msgs_image cannot be nullptr")
                  .pointer->header),
      frame_(unique_sensor_msgs_image->height,
...
ROSCvMatContainer::ROSCvMatContainer(
    ...
    : header_(shared_sensor_msgs_image->header),
      frame_(shared_sensor_msgs_image->height,
...
ROSCvMatContainer::ROSCvMatContainer(const cv::Mat& mat_frame,
...
ROSCvMatContainer::ROSCvMatContainer(cv::Mat&& mat_frame,
                                     const std_msgs::msg::Header& header,
                                     bool is_bigendian)
    : header_(header),
...
ROSCvMatContainer::ROSCvMatContainer(
    ...
    : ROSCvMatContainer(
          std::make_unique<sensor_msgs::msg::Image>(sensor_msgs_image)) {}

bool ROSCvMatContainer::is_owning() const {
  return std::holds_alternative<std::nullptr_t>(storage_);
}

const cv::Mat& ROSCvMatContainer::cv_mat() const {
  return frame_;
}

cv::Mat ROSCvMatContainer::cv_mat() {
  return frame_;
}

const std_msgs::msg::Header& ROSCvMatContainer::header() const {
  return header_;
}

std_msgs::msg::Header& ROSCvMatContainer::header() {
  return header_;
}
...
bool ROSCvMatContainer::is_bigendian() const {
